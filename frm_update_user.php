...
<?php
 $select_query =mysqli_query("SELECT * FROM tbl_user WHERE user_id = $get_user_id");
 //$result =mysqli_fetch_array("$select_query");

?>

<form action="" method="post" name="frm_add_user">
<table width="528" height="218" border="0">
  <tr>
    <td width="121">User label</td>
    <td width="11">:</td>
    <td width="382"><input name="txt_user_label" type="text" value="hh"/></td>
  </tr>
  <tr>
    <td>Gender</td>
    <td>:</td>
